...
class SimpleImpl : public Simple, public OverlapHello
{
	BICOMC_OVERRIDE(Simple, OverlapHello)
		Simple::BICOMC_OVER_METHOD_C(hello, void());
...
extern "C" BICOMC_EXPORT bcc::Object* CreateObject()
{
	try
	{
		return static_cast<Simple*>(new SimpleImpl());
	}
