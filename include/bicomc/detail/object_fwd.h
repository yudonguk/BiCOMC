...
#define BICOMC_OVER_OPERATOR_UNARY_PLUS(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_UNARY_PLUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_UNARY_PLUS_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_UNARY_PLUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_UNARY_PLUS_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_UNARY_PLUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_UNARY_PLUS_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_UNARY_PLUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_UNARY_MINUS(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_UNARY_MINUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_UNARY_MINUS_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_UNARY_MINUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_UNARY_MINUS_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_UNARY_MINUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_UNARY_MINUS_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_UNARY_MINUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PLUS(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_PLUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PLUS_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_PLUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PLUS_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_PLUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PLUS_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_PLUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MINUS(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_MINUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MINUS_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_MINUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MINUS_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_MINUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MINUS_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_MINUS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DEREFERENCE(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_DEREFERENCE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DEREFERENCE_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_DEREFERENCE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DEREFERENCE_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_DEREFERENCE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DEREFERENCE_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_DEREFERENCE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PRODUCT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_PRODUCT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PRODUCT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_PRODUCT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PRODUCT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_PRODUCT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PRODUCT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_PRODUCT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DIVIDE(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_DIVIDE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DIVIDE_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_DIVIDE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DIVIDE_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_DIVIDE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DIVIDE_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_DIVIDE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MODULO(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_MODULO, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MODULO_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_MODULO, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MODULO_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_MODULO, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MODULO_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_MODULO, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_XOR(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_BITWISE_XOR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_XOR_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_BITWISE_XOR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_XOR_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_BITWISE_XOR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_XOR_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_BITWISE_XOR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_ADDRESS_OF(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_ADDRESS_OF, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_ADDRESS_OF_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_ADDRESS_OF, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_ADDRESS_OF_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_ADDRESS_OF, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_ADDRESS_OF_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_ADDRESS_OF, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_AND(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_BITWISE_AND, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_AND_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_BITWISE_AND, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_AND_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_BITWISE_AND, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_AND_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_BITWISE_AND, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_OR(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_BITWISE_OR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_OR_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_BITWISE_OR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_OR_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_BITWISE_OR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_OR_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_BITWISE_OR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_NOT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_BITWISE_NOT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_NOT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_BITWISE_NOT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_NOT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_BITWISE_NOT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_NOT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_BITWISE_NOT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_NOT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_LOGICAL_NOT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_NOT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_LOGICAL_NOT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_NOT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_LOGICAL_NOT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_NOT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_LOGICAL_NOT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LESS(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_LESS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LESS_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_LESS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LESS_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_LESS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LESS_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_LESS, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_GREATER(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_GREATER, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_GREATER_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_GREATER, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_GREATER_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_GREATER, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_GREATER_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_GREATER, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PLUS_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_PLUS_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PLUS_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_PLUS_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PLUS_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_PLUS_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PLUS_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_PLUS_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MINUS_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_MINUS_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MINUS_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_MINUS_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MINUS_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_MINUS_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MINUS_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_MINUS_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PRODUCT_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_PRODUCT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PRODUCT_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_PRODUCT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PRODUCT_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_PRODUCT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PRODUCT_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_PRODUCT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DIVIDE_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_DIVIDE_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DIVIDE_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_DIVIDE_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DIVIDE_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_DIVIDE_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_DIVIDE_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_DIVIDE_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MODULO_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_MODULO_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MODULO_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_MODULO_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MODULO_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_MODULO_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_MODULO_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_MODULO_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_XOR_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_BITWISE_XOR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_XOR_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_BITWISE_XOR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_XOR_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_BITWISE_XOR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_XOR_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_BITWISE_XOR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_AND_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_BITWISE_AND_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_AND_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_BITWISE_AND_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_AND_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_BITWISE_AND_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_AND_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_BITWISE_AND_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_OR_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_BITWISE_OR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_OR_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_BITWISE_OR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_OR_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_BITWISE_OR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_BITWISE_OR_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_BITWISE_OR_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LEFT_SHIFT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_LEFT_SHIFT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LEFT_SHIFT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_LEFT_SHIFT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LEFT_SHIFT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_LEFT_SHIFT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LEFT_SHIFT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_LEFT_SHIFT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_RIGHT_SHIFT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_RIGHT_SHIFT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_RIGHT_SHIFT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_RIGHT_SHIFT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_RIGHT_SHIFT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_RIGHT_SHIFT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_RIGHT_SHIFT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_RIGHT_SHIFT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LEFT_SHIFT_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_LEFT_SHIFT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LEFT_SHIFT_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_LEFT_SHIFT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LEFT_SHIFT_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_LEFT_SHIFT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LEFT_SHIFT_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_LEFT_SHIFT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_RIGHT_SHIFT_ASSIGN(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_RIGHT_SHIFT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_RIGHT_SHIFT_ASSIGN_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_RIGHT_SHIFT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_RIGHT_SHIFT_ASSIGN_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_RIGHT_SHIFT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_RIGHT_SHIFT_ASSIGN_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_RIGHT_SHIFT_ASSIGN, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_EQUAL(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_EQUAL_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_EQUAL_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_EQUAL_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_NOT_EQUAL(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_NOT_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_NOT_EQUAL_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_NOT_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_NOT_EQUAL_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_NOT_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_NOT_EQUAL_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_NOT_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LESS_EQUAL(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_LESS_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LESS_EQUAL_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_LESS_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LESS_EQUAL_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_LESS_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LESS_EQUAL_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_LESS_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_GREATER_EQUAL(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_GREATER_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_GREATER_EQUAL_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_GREATER_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_GREATER_EQUAL_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_GREATER_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_GREATER_EQUAL_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_GREATER_EQUAL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_AND(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_LOGICAL_AND, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_AND_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_LOGICAL_AND, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_AND_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_LOGICAL_AND, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_AND_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_LOGICAL_AND, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_OR(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_LOGICAL_OR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_OR_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_LOGICAL_OR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_OR_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_LOGICAL_OR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_LOGICAL_OR_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_LOGICAL_OR, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_COMMA(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_COMMA, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_COMMA_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_COMMA, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_COMMA_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_COMMA, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_COMMA_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_COMMA, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PREFIX_INCREMENT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_PREFIX_INCREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PREFIX_INCREMENT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_PREFIX_INCREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PREFIX_INCREMENT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_PREFIX_INCREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PREFIX_INCREMENT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_PREFIX_INCREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POSTFIX_INCREMENT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_POSTFIX_INCREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POSTFIX_INCREMENT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_POSTFIX_INCREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POSTFIX_INCREMENT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_POSTFIX_INCREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POSTFIX_INCREMENT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_POSTFIX_INCREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PREFIX_DECREMENT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_PREFIX_DECREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PREFIX_DECREMENT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_PREFIX_DECREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PREFIX_DECREMENT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_PREFIX_DECREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_PREFIX_DECREMENT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_PREFIX_DECREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POSTFIX_DECREMENT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_POSTFIX_DECREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POSTFIX_DECREMENT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_POSTFIX_DECREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POSTFIX_DECREMENT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_POSTFIX_DECREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POSTFIX_DECREMENT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_POSTFIX_DECREMENT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POINTER_TO_MEMBER(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_POINTER_TO_MEMBER, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POINTER_TO_MEMBER_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_POINTER_TO_MEMBER, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POINTER_TO_MEMBER_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_POINTER_TO_MEMBER, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_POINTER_TO_MEMBER_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_POINTER_TO_MEMBER, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_STRUCTURE_DEREFERENCE(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_STRUCTURE_DEREFERENCE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_STRUCTURE_DEREFERENCE_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_STRUCTURE_DEREFERENCE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_STRUCTURE_DEREFERENCE_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_STRUCTURE_DEREFERENCE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_STRUCTURE_DEREFERENCE_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_STRUCTURE_DEREFERENCE, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_SUBSCRIPT(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_SUBSCRIPT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_SUBSCRIPT_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_SUBSCRIPT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_SUBSCRIPT_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_SUBSCRIPT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_SUBSCRIPT_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_SUBSCRIPT, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_CALL(METHOD_TYPE, ...) BICOMC_OVER_METHOD(BICOMC_OPERATOR_CALL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_CALL_C(METHOD_TYPE, ...) BICOMC_OVER_METHOD_C(BICOMC_OPERATOR_CALL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_CALL_V(METHOD_TYPE, ...) BICOMC_OVER_METHOD_V(BICOMC_OPERATOR_CALL, METHOD_TYPE, __VA_ARGS__)
#define BICOMC_OVER_OPERATOR_CALL_CV(METHOD_TYPE, ...) BICOMC_OVER_METHOD_CV(BICOMC_OPERATOR_CALL, METHOD_TYPE, __VA_ARGS__)
